...
public class MultiThreadedEx {
    public static void main(String[] args) {
        ...
        evenThread.setName("Thread-even");
        OddThread oddThread = new OddThread(); 
        Thread oddThreadForRunnable = new Thread(oddThread);
        oddThreadForRunnable.setName("Thread-odd");
        evenThread.start();
        oddThreadForRunnable.start();
//        compute.odd();
...
//        }
        ...
        System.out.println("End of the program! from " + currentThread.getName());
        try {
            // sleep for 5 seconds
